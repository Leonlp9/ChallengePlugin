...
public class FindAVillage extends BaseAdvancement {
    public FindAVillage(RootAdvancement root) {
        super("find_a_village", new AdvancementDisplay(Material.VILLAGER_SPAWN_EGG, "Bau dir ein eigenes!", AdvancementFrameType.TASK, true, true, 1f, 0, "Finde ein Village. Der Anfang jedes Projektes"), root);
