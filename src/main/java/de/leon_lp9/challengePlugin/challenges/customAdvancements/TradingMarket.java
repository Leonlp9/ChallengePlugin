...
public class TradingMarket extends BaseAdvancement implements ParentGrantedVisibility {
    public TradingMarket(@NotNull Advancement parent) {
        super("trading_market", new AdvancementDisplay(Material.EMERALD_BLOCK, "Trading Market", com.fren_gor.ultimateAdvancementAPI.advancement.display.AdvancementFrameType.TASK, true, true, 3f, 3f+10f, "Villager auf max Stufe traden"), parent);
