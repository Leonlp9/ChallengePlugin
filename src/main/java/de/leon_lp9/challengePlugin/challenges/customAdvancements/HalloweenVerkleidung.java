...
public class HalloweenVerkleidung extends BaseAdvancement {
    public HalloweenVerkleidung(@NotNull Advancement parent) {
        super("halloween_verkleidung", new AdvancementDisplay(org.bukkit.Material.JACK_O_LANTERN, "Halloween Verkleidung", com.fren_gor.ultimateAdvancementAPI.advancement.display.AdvancementFrameType.TASK, true, true, 2f, 2f, "Setze einem Villager einen geschnitzten Kürbis auf"), parent);
