...
public class OEffentlicherNahverkehr extends BaseAdvancement implements ParentGrantedVisibility {
    public OEffentlicherNahverkehr(@NotNull Advancement parent) {
        super("oeffentlicher_nahverkehr", new AdvancementDisplay(org.bukkit.Material.MINECART, "Öffentlicher Nahverkehr", AdvancementFrameType.TASK, true, true, 4f, 2f+10f, "Fahre 1000 Blöcke mit einem Minecart"), parent, 1000);
